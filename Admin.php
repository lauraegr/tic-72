...
?>
    ...
    echo "<br><br><br><br><br><br>";
        <div class="col">
            ...
            echo" <table align='center'><tr><td><h10><font size='6' color='#black'><b>BIENVENIDO AL SISTEMA</b></font></h10>".
			
            "<center><h10><font size='5' color='#black'><b>$Nombre $APP $APM</b></font></h10></center></td></tr>";
            ?>
        <!--<center><tr><td><img src="images/user1.png" width="250" height="250"> -->
                <!--<?php
                echo"HOY:"."",date ("d/m/Y");
